    ...
    <div class="home-banner">
      <div class="carousel">
        ...
        <a href="new.php">
          ...
          <div class="carousel-item">
              <div class="slide-image"
                  style="background-image: url('images/banners/home-new.png');">
              </div>
          </div>
        </a>
        ...
        <a href="women.php">
          <!-- edit file name to link here -->
          <div class="carousel-item">
              <div class="slide-image" style="background-image: url('images/banners/home-women.png');">
              </div>
          </div>
        </a>
        ...
        <a href="men.php">
          ...
          <div class="carousel-item">
              <div class="slide-image"
                  style="background-image: url('images/banners/home-men.png');">
              </div>
          </div>
        </a>
